...
class BcvAnalyzerTests(unittest.TestCase):
    ...
    def test_main_uses_hardcoded_catalog_and_schema(self):
        ...
        src_rows = [
            ...
            {"Column": "request__context__distributor_asset_id", "Type": "bigint", "Extra": "", "Comment": "internal"},
    ...
    def test_execute_sql_runs_statement_and_returns_dict_rows(self):
        ...
        self.assertEqual(calls[0][0][0], "trino://analyst@presto.example.com:8443/mrm_log_flat/default")
