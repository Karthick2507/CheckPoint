# CheckPoint — Data Quality & ETL

This repository contains two complementary tools for Presto/Trino data work:

| Tool | Use it for | Docs |
|------|------------|------|
| **ETL Framework** | Repeatable, config-driven ETL + Great Expectations data quality across **pluggable sources** (Presto, Snowflake, …) | [Quickstart below](#etl-framework) · [`DESIGN.md`](DESIGN.md) |
| **BCV Analyzer** | One-off schema-diff + value validation between **SRC** and **BCV** tables, with backfill recommendations | [BCV Analyzer section](#bcv-analyzer) |
