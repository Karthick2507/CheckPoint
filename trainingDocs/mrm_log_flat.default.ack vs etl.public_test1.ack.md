...
`ack__ack_entity_type, ack__metrics__ad_net_avail,ack__metrics__ad_gross_avail`,`ack__metrics__ad_unconstrained_gross_avail`are not supported in Hoover++ with reference - Entity - AckCtx
...
**++ Updated and resolved, tracked here with pr:++**Event Level (Backward Compatible Views)
